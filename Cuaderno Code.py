...
def new_file():
    # create main frame
    new_frame = Frame(tc)
    tc.add(new_frame, text="Untitled")
    ...
    hor_scroll = Scrollbar(new_frame, orient='horizontal')
    hor_scroll.pack(side=BOTTOM, fill=X, ipady=5)

    #create text box
    my_text = Text(new_frame, width=197, height=39, font=("Liberation Serif", 13), selectbackground="black", selectforeground="yellow", undo=True, yscrollcommand=text_scroll.set, wrap="none", xscrollcommand=hor_scroll.set)
    my_text.pack()
...
#create text box
my_text = Text(my_frame, width=197, height=39, font=("Liberation Serif", 13), selectbackground="black", selectforeground="yellow", undo=True, yscrollcommand=text_scroll.set, wrap="none", xscrollcommand=hor_scroll.set)
my_text.pack()
